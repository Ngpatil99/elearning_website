	...
	<div class="container">
		<nav class="navbar navbar-inverse navbar-static-top">
			<div class="navbar-header">
				...
				<a class="navbar-brand" href="index.html"><h1>E-learning</h1></a>
			</div>
	...
	<div class='header'>
		<div class="container">
			<div class="banner-agileits">
				<h2>E-learning Is The Sound Of The Future</h2>	
...
<section class="about-agileits" id="about">
	<div class="container">
		...
		<div class="col-lg-6 col-md-6 col-sm-12 about-w3ls2" data-aos="zoom-in">
			<div class="about-w3l">
				<h3><span class="fa fa-diamond" aria-hidden="true"></span>E-learning about us.</h3>	
			...
			<div class="subscribe">
				<form action="#" method="post">
					<div class="form-group2">
						<button class="btn btn-outline btn-lg" type="submit">demo</button>
					</div>
					<div class="clearfix"></div>
				</form>
			</div>	
			...
			if(isset($_POST['ok']))
                    {
						...
						$to='info@elearning.in';
						$header .= "MIME-Version: 1.0"."\r\n";
        $header .= 'Content-type: text/html; charset=iso-8859-1'."\r\n";
        $header="From: <$from> \r\n";
        $header.='Cc:payal.dhakane@gmail.com'." \r\n";
        $header.='Cc:aishk78@gmail.com'." \r\n";

       // $header .='Bcc:payal.dhakane@gmail.com'." \r\n";
                       ...
                       if(mail ($to,$subject,$message,$header))
                       {
                           ...
                           echo ("<SCRIPT LANGUAGE='JavaScript'>
                             window.alert('Your Message was Sent Successfully..We Will Contact You Soon')
		...
		<div class="col-lg-12" data-aos="zoom-in">
			<ul class="contact-info">
				<li>
					...
					<p class="contact-p1">7654098321</p>
					<p class="contact-p2">8900124567</p>
				</li>
				<li>
		...
		<form action="#" method="post" name="sentMessage" id="contactForm" novalidate>
            <div class="col-lg-4 col-md-4 col-sm-4" data-aos="zoom-in">    
				<div class="control-group form-group">
                    <div class="controls">
                        ...
                        <input type="text" class="form-control" id="name" name="name" pattern="[a-z,A-Z\s]{3,50}"  required data-validation-required-message="Please enter your name." style="width: 160% !important">
			...
			<div class="col-lg-4 col-md-4 col-sm-4" data-aos="zoom-in">	
                <div class="control-group form-group">
					<div class="controls">
						...
						<input type="tel" class="form-control" id="phone" name="contact" pattern="[6-9]{1}[0-9]{9}" required data-validation-required-message="Please enter your phone number." style="width: 160% !important">
                    </div>
                </div>
			</div>
			<div class="clearfix"></div>	
			<div class="col-lg-4 col-md-4 col-sm-4" data-aos="zoom-in">			
                <div class="control-group form-group">
                    <div class="controls">
                        ...
                        <input type="email" class="form-control" id="email" name="email" pattern="[a-zA-z0-9]+\.?[a-zA-z0-9]+@[a-zA-z0-9.-]+\.[a-z]{2,3}" required data-validation-required-message="Please enter your email address." style="width: 160% !important">
                    </div>
                </div>
			</div>
			<div class="clearfix"></div>
			<div class="col-lg-12" data-aos="zoom-in">	
                <div class="control-group form-group">
                    <div class="controls">
                        <label>Message:</label>
                        <textarea rows="10" cols="50" class="form-control" id="message" name="message" required data-validation-required-message="Please enter your message" maxlength="500" style="resize:none; width:50%;"></textarea>
					</div>
                </div>
                <div id="success"></div>
			...
			<div class="col-lg-12" data-aos="zoom-in">	
                <button type="submit" class="btn btn-primary" name="ok" >Send Message</button>
            </div>
			<div class="clearfix"></div>	
		</form>	
	</div>
...
<section class="footer-wthree">
	...
	<p class="copyright">© 2017 E-learning. All Rights Reserved | Design by <a href="http://www.binarybridgeindia.com/" target="_blank">Binarybridge technologies India pvt ltd</a></p>
